...
**Requirement**: Before design/coding, you must search Kex for rules relevant to your task and list them here.
...
- [Rule Name]: <1-line summary of constraint>
```

### Process

1.  **Analyze Task**: "What rules might apply?" (e.g., "go", "testing", "naming").
